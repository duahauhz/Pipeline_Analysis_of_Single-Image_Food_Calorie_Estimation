...
|---|---:|---:|---:|---:|---|
| 1 view (top only) | 158 | 48.43% | 61.6 | 34.18% | depth = min(W,H) × depth_ratio (per class) |
| 2 views (top + side) | 158 | 46.53% | 58.44 | 42.41% | real L×W×D từ 2 silhouette |
...
|---|---:|---:|---:|---:|---:|
| apple | 23 | 25.03% | 23 | 24.20% | -0.83 pp |
| banana | 18 | 75.00% | 18 | 79.09% | +4.09 pp |
| bread | 7 | 343.75% | 7 | 256.55% | -87.20 pp |
| bun | 8 | 51.72% | 8 | 19.09% | -32.63 pp |
| doughnut | 9 | 10.16% | 9 | 68.90% | +58.74 pp |
...
| orange | 16 | 22.88% | 16 | 22.31% | -0.57 pp |
...
## Nhận xét
- 2-view pipeline cải thiện MAPE -1.90 pp so với 1-view (48.43% → 46.53%).
